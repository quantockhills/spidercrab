...
test.describe('Handler Check', () => {
  test('Check if handler is called', async ({ page }) => {
    ...
    page.on('console', msg => {
      ...
      console.log(`[ALL] [${msg.type()}] ${t}`);
    });
    page.on('pageerror', err => console.log(`[ALL] [PAGE_ERROR] ${err.message}`));
